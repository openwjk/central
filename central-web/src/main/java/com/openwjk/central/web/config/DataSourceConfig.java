...
public class DataSourceConfig {
    ...
    private Map<String, DataSource> createDataSources() {
        ...
        dataSource2.setDriverClassName(dataSourceProperties.getShardingJdbc().get(Constant.INT_ONE).getDriverClassName());
        dataSource2.setUrl(dataSourceProperties.getShardingJdbc().get(Constant.INT_ONE).getUrl());
        dataSource2.setUsername(dataSourceProperties.getShardingJdbc().get(Constant.INT_ONE).getUsername());
        dataSource2.setPassword(dataSourceProperties.getShardingJdbc().get(Constant.INT_ONE).getPassword());
