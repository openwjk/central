...
CREATE TABLE `ct_file` (
    ...
    `FILE_STORE_BUCKET` varchar(32) CHARACTER SET utf8 DEFAULT NULL COMMENT '文件存储bucket',
    `FILE_STORE_KEY` varchar(64) CHARACTER SET utf8 DEFAULT NULL COMMENT '文件存储key',
    `ORIGINAL_NAME` varchar(500) DEFAULT NULL COMMENT '原始文件名称',
